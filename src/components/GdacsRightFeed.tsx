...
export default function GdacsRightFeed({
  ...
  return (
    /* Docked wherever the caller renders it — no Card/absolute wrapper, so
       this fills its parent instead of floating over the map. */
    <Layout
      header={
        <LayoutHeader hasDivider padding={4}>
          <VStack gap={0.5}>
            <HStack gap={2} vAlign="center">
              <Radio className="w-6 h-6 text-neutral-300 shrink-0" />
